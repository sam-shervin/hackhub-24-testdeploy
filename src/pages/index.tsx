...
export default function Home() {
  ...
  return (
    ...
    >
      <motion.section className="font-offbittrialdot text-[70px] sm:text-6xl md:text-8xl gap-4 pr-72 space-y-[-20px]">
      ...
      <motion.section className="font-glitch text-[10rem] sm:text-6xl md:text-8xl flex gap-4 w-screen flex justify-center">
      ...
      <motion.section className="font-offbittrial text-[35px] sm:text-6xl md:text-8xl flex gap-4">
